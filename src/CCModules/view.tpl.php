...
<tbody>
  <tr><td>Part of MyFrameWork Core modules</td><td><?=$module['isMyFrameWorkCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of MyFrameWork CMF modules</td><td><?=$module['isMyFrameWorkCMF']?'Yes':'No'?></td></tr>
